...
rr %>%
  ...
  labs(x = "Wave", y = "Re-interview rates", color = "Level",
       ...
       caption = "Please note change of scales") +
  scale_color_grey() +
  scale_shape_manual(values = c(16, 15, 3, 7, 8)) 

ggsave("./results/R&R2/rr_plot_difscale.png", dpi = 500, height = 8)
...
ggsave("./results/R&R2/rr_plot_balanced_difscale.png", dpi = 500, height = 8)
...
ggsave("./results/R&R2/rindicators_difscale.png", dpi = 500, height = 8, width = 8)

ggsave("./results/R&R2/rindicators_difscale.jpg", dpi = 500, height = 8, width = 8)
...
new_data5 %>%
  ...
  mutate(wave2 = str_c("Wave ", wave),
         sim3a = ifelse(sim3 == "Yes", "In sim3", "Not in sim3") %>% 
           as.factor(),
         sim4a = ifelse(sim4 == "Yes", "In sim4", "Not in sim4") %>% 
           as.factor(),
...
ggsave("./results/R&R2/prob_plots_sim3.png", dpi = 300)
ggsave("./results/R&R2/prob_plots_sim3.jpg", dpi = 300)
